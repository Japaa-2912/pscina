        ...
        {services.map((item, index) => (
          <Reveal key={item.id} delay={index * 40}>
            <button
              ...
              className="group flex h-full w-full flex-col rounded-2xl border border-deep/10 bg-cream p-6 text-left transition-all duration-200 hover:-translate-y-0.5 hover:border-deep/20 hover:shadow-md focus-visible:outline-2 focus-visible:outline-offset-2"
            >
