...
export function DropletIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 10.5c0 1.5-1 2.5-2.5 2.5" />
    </svg>
  );
}
...
export function WrenchIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg
      ...
      focusable="false"
    >
      <path d="M14.7 6.3a5 5 0 0 0-6.4 6.4L3 18l3 3 5.3-5.3a5 5 0 0 0 6.4-6.4l-3 3-2.1-.6-.6-2.1 3-3Z" />
    </svg>
  );
}
...
export function SparkleIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M19 14c.3 2 1 2.7 3 3-2 .3-2.7 1-3 3-.3-2-1-2.7-3-3 2-.3 2.7-1 3-3Z" />
    </svg>
  );
}