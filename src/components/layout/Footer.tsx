...
export function Footer() {
  ...
  const regionLabel =
    site.region || [site.city, site.state].filter(Boolean).join(" · ");
      ...
      <div className="mx-auto w-full max-w-6xl px-5 py-14 sm:px-8 sm:py-16">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            {regionLabel && (
              <p className="mt-5 flex items-center gap-2 text-sm font-normal text-sand-light">
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <a
                  ...
                  className="inline-flex items-center gap-2.5 text-sm font-normal text-white transition-colors hover:text-sand-light"
                >
